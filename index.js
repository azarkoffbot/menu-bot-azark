...
global.mods = ['4191721216@s.whatsapp.net']
global.prems = ['4191721216@s.whatsapp.net']

global.dfail = (type, m, conn) => {
  let msg = {
    owner: 'SOMENTE O CRIADOR DO BOT!',
    mods: 'SO O BOT PODE FAZER O COMANDO',
    premium: 'TEM QUE PRA USAR KKKKK!',
    group: 'COMANDO SO PODEE SER FEITO EM GRUPOS!',
    private: 'COMANDO SO FUNCIONA NO PV!',
    admin: 'BOT PRECISA SER ADEMIR!',
    botAdmin: 'BOT TEM QUE SER ADEMIR!'
  }[type]
